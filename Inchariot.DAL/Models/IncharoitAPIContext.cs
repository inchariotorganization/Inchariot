...
using Inchariot.DAL.Models.Mapping;

namespace Inchariot.DAL.Models
{
    public partial class IncharoitAPIContext : DbContext
    {
        static IncharoitAPIContext()
        {
            Database.SetInitializer<IncharoitAPIContext>(null);
        }
